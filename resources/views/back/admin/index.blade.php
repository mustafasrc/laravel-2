                            ...
                            <div class="block block-themed block-fx-shadow mb-0">
                                ...
                                <div class="block-content">
                                    <div class="p-sm-3 px-lg-4 py-lg-5">
                                        <h1 class="mb-2">Hoşgeldin</h1>
                                        <p>Email Ve Şifre Yazınız</p>
                                        @if($errors->any())
                                        ...
                                        <form class="js-validation-signin" action="{{route('admin.login')}}" method="POST">
                                            ...
                                            <div class="py-3">
                                                <div class="form-group">
                                                    <input type="email" class="form-control form-control-alt form-control-lg" id="login-username" name="email" placeholder="Email Adres">
                                                </div>
                                                <div class="form-group">
...
-->
<script src="{{asset('back')}}/assets/js/oneui.core.min.js"></script>
...
<!-- Page JS Plugins -->
<script src="{{asset('back')}}/assets/js/plugins/jquery-validation/jquery.validate.min.js"></script>

<!-- Page JS Code -->
<script src="{{asset('back')}}/assets/js/pages/op_auth_signin.min.js"></script>
</body>
</html>
