    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-6 col-lg-3">
                <a class="block block-link-shadow text-center" href="{{route('admin.urunler.create')}}">
            ...
            <div class="col-6 col-lg-3">
                <a class="block block-link-shadow text-center" href="be_pages_ecom_dashboard.html">
                    <div class="block-content block-content-full">
                        <div class="font-size-h2 text-dark">{{$products->count()}}</div>
                    </div>
                    <div class="block-content py-2 bg-body-light">
                ...
                <div class="table-responsive">
                    <table class="table table-borderless table-striped table-vcenter">
                        ...
                        <tr>
                            ...
                            <th class="d-none d-md-table-cell">Ürün Resmi</th>
                            <th class="d-none d-md-table-cell">Kategori</th>
                            <th class="d-none d-sm-table-cell text-center">Oluşturulma Zamanı</th>
                            <th>Stok Durumu</th>
                            <th class="d-none d-sm-table-cell text-right">Fiyat</th>
                        ...
                        <tr>
                            ...
                            <td class="d-none d-md-table-cell font-size-sm">
                                <img src="{{$product->image}}" style="width: 300px; height: 190px;">
                            </td>
                            <td class="d-none d-md-table-cell font-size-sm">
                                {{$product->getCategory['name']}}
                            </td>
                            <td class="d-none d-sm-table-cell text-center font-size-sm">{{$product->created_at->diffForHumans()}}</td>
                            <td>
                                @if($product->stock > 0)
                            ...
                            <td class="text-center font-size-sm">
                                <a class="btn btn-sm btn-alt-secondary" href="{{route('admin.urunler.edit' , $product->id)}}" data-toggle="tooltip" title="View">
                                    <i class="fa fa-fw fa-eye"></i>
                                </a>
                                <form action="{{route('admin.urunler.destroy' , $product->id)}}" method="post">
                                    @csrf
                                    @method('DELETE')
