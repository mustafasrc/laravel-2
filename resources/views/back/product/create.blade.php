                    ...
                    <div class="col-md-10 col-lg-8">
                        <form action="{{route('admin.urunler.store')}}" method="POST"  enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="js-ckeditor" name="content" class="form-control" required></textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="one-ecom-product-price" name="price"  required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-6">
                                    <label for="one-ecom-product-stock">Stok Miktari</label>
                                    <input type="text" class="form-control" id="one-ecom-product-stock" name="stock" required>
                                </div>
                            </div>
                            <div class="form group row">
