            ...
            <div class="col-6 col-lg-3">
                <a class="block block-link-shadow text-center" href="javascript:void(0)">
                    <div class="block-content block-content-full">
                        <div class="font-size-h2 text-danger">{{$categories->count()}}</div>
                    </div>
                       ...
                       <div class="table-responsive">
                           <table class="table table-borderless table-striped table-vcenter">
                               ...
                               <tr>
                                   ...
                                   <th class="d-none d-sm-table-cell text-center">Ürün sayısı</th>
                                   <th>Status</th>
                               ...
                               @foreach($categories as $category)
                                   <tr>
                                       ...
                                       <td class="d-none d-sm-table-cell text-center font-size-sm">{{$category->getCount->count()}}</td>
                                       <td>
                                            @if($category->status == 0) <p class="text-danger">Pasif</p> @endif
                                                @if($category->status == 1) <p class="text-success">Aktif</p> @endif
                                       </td>
                                       <td class="text-right d-none d-sm-table-cell font-size-sm">
                                           <strong>{{$category->created_at->diffForHumans()}}</strong>
                                       </td>
                                       <td class="text-center font-size-sm">
                                           <a class="btn btn-sm btn-alt-secondary" href="{{route('admin.kategori.edit' , $category->id)}}" data-toggle="tooltip" title="View">
